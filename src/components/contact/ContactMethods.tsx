...
// TODO: Replace with real phone number when available
export const CONTACT_PHONE: string = '' // No phone number yet — set when ready
  ...
  return (
    <section className="py-12 md:py-16">
      <div className="mx-auto max-w-[800px] px-6">
        <div className={`grid grid-cols-1 gap-6 ${phone ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}>
          {/* Phone Card — only shown when a real phone number is configured */}
          {phone && (
